...
/**
 * BQServiceSchedulingInitiateOutputModel
 */
public class BQServiceSchedulingInitiateOutputModel   {
  private String serviceSchedulingInstanceReference = null;

  private String serviceSchedulingInitiateActionReference = null;
  ...
  **/
   ...
   * @return serviceSchedulingInitiateActionReference
  **/

  public String getServiceSchedulingInitiateActionReference() {
    return serviceSchedulingInitiateActionReference;
  }

  public void setServiceSchedulingInitiateActionReference(String serviceSchedulingInitiateActionReference) {
    this.serviceSchedulingInitiateActionReference = serviceSchedulingInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Service Scheduling instance (e.g. initialised, pending, active) 
