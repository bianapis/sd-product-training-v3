...
/**
 * BQServiceDeliveryExecuteOutputModel
 */
public class BQServiceDeliveryExecuteOutputModel   {
  ...
  private String serviceDeliveryExecuteActionTaskReference = null;

  private Object serviceDeliveryExecuteActionTaskRecord = null;

  private String serviceDeliveryExecuteRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Service Delivery instance execute service call 
   * @return serviceDeliveryExecuteActionTaskReference
  **/

  public String getServiceDeliveryExecuteActionTaskReference() {
    return serviceDeliveryExecuteActionTaskReference;
  }

  public void setServiceDeliveryExecuteActionTaskReference(String serviceDeliveryExecuteActionTaskReference) {
    this.serviceDeliveryExecuteActionTaskReference = serviceDeliveryExecuteActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The execute service call consolidated processing record 
   * @return serviceDeliveryExecuteActionTaskRecord
  **/

  public Object getServiceDeliveryExecuteActionTaskRecord() {
    return serviceDeliveryExecuteActionTaskRecord;
  }

  public void setServiceDeliveryExecuteActionTaskRecord(Object serviceDeliveryExecuteActionTaskRecord) {
    this.serviceDeliveryExecuteActionTaskRecord = serviceDeliveryExecuteActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Service Delivery execute transaction/record 
   * @return serviceDeliveryExecuteRecordReference
  **/

  public String getServiceDeliveryExecuteRecordReference() {
    return serviceDeliveryExecuteRecordReference;
  }

  public void setServiceDeliveryExecuteRecordReference(String serviceDeliveryExecuteRecordReference) {
    this.serviceDeliveryExecuteRecordReference = serviceDeliveryExecuteRecordReference;
  }
